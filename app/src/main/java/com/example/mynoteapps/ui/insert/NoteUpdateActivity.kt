...
class NoteUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_submit.setOnClickListener {
            ...
            if (title.isEmpty()) {
                ...
                if (isEdit) {
                    noteUpdateViewModel.update(note as Note)
                    ...
                    noteUpdateViewModel.insert(note as Note)
        ...
        with(alertDialogBuilder){
            ...
            setPositiveButton(getString(R.string.yes)) { dialog, id ->
                if (isDialogClose) {
                    ...
                    noteUpdateViewModel.delete(note as Note)
                    val intent = Intent()
    ...
    private fun obtainViewModel(activity: AppCompatActivity): NoteUpdateViewModel {
        ...
        return ViewModelProvider(activity, factory)[NoteUpdateViewModel::class.java]
    }
}
